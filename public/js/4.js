...
/* harmony import */ var _core_services_store_auth_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/core/services/store/auth.module */ "./resources/js/src/core/services/store/auth.module.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    var signup_form = _assets_js_components_util__WEBPACK_IMPORTED_MODULE_5__["default"].getById("kt_login_signup_form");
    var forgot_form = _assets_js_components_util__WEBPACK_IMPORTED_MODULE_5__["default"].getById("kt_login_forgot_form");
    ...
    this.fv.on("core.form.valid", function () {
      ...
      _this.$store.dispatch(_core_services_store_auth_module__WEBPACK_IMPORTED_MODULE_7__["LOGOUT"], {
        email: email,
        password: password
      ...
      setTimeout(function () {
        // send login request
        _this.$store.dispatch(_core_services_store_auth_module__WEBPACK_IMPORTED_MODULE_7__["LOGIN"], {
          email: email,
          password: password
    ...
    this.fv1.on("core.form.valid", function () {
      ...
      setTimeout(function () {
        ...
        _this.$store.dispatch(_core_services_store_auth_module__WEBPACK_IMPORTED_MODULE_7__["REGISTER"], {
          name: name,
          email: email,
          password: password
        }).then(function () {
